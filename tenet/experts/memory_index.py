...
# lowest-level module, so both the cover producer (``tenet.experts.cover``) and the client
# routing scorer (``tenet.experts.expert_route``) can share it without an import cycle.
COVER_MARKER = "cover"
